"""
Django settings for moberries_challenge project.
...
SECRET_KEY = 'django-insecure-t4j3dg*at=9f)cb70%j)ev7x@m0^l!+br(z^%7$gn@^a=c)v-r'
...
ROOT_URLCONF = 'moberries_challenge.urls'
...
WSGI_APPLICATION = 'moberries_challenge.wsgi.application'
...
CACHEOPS = {
    'pizza.pizza': {'ops': {'fetch', 'get'}, 'timeout': 60*60},
    'pizza.customer': {'ops': {'fetch', 'get'}, 'timeout': 60*60},
}
